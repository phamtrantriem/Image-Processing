...
def brightness():
    ...
    image_processing.brightness(value)
    print(value, file=sys.stderr)
    return render_template("uploaded.html", file_path="img/img_now.jpg")
...
def segmentation():
    ...
    image_processing.threshold(low, high)
    return render_template("uploaded.html", file_path="img/img_now.jpg")
...
def histogram_rgb():
    ...
    if image_processing.is_grey_scale("static/img/img_now.jpg"):
        ...
        return render_template("histogram.html", file_paths=["img/red_histogram.jpg", "img/green_histogram.jpg",
...
@nocache
def smoothing():
    matrix = int(request.form['matrix'])
    print("matrix", sys.stdout)
    print(matrix, sys.stdout)
    image_processing.smoothing(matrix)
    return render_template("uploaded.html", file_path="img/img_now.jpg")
